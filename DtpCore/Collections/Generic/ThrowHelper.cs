...
namespace DtpCore.Collections.Generic
{
    ...
    internal static class ThrowHelper
    {
        ...
        {
            throw new ArgumentException(GetResourceString("Arg_WrongType"), "key");
        }

        internal static void ThrowWrongValueTypeArgumentException(object value, Type targetType)
        {
            throw new ArgumentException(GetResourceString("Arg_WrongType"), "value");
        }
        ...
        internal static string GetResourceString(string txt)
        {
            return txt;
        }
