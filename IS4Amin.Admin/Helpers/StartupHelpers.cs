...
using IS4Amin.Admin.ExceptionHandling;
using IS4Amin.Admin.Middlewares;
using IS4Amin.Admin.Configuration;
using IS4Amin.Admin.Configuration.ApplicationParts;
using IS4Amin.Admin.Configuration.Constants;
using IS4Amin.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using IS4Amin.Admin.Helpers.Localization;

namespace IS4Amin.Admin.Helpers
{
