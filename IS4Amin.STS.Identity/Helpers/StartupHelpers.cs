...
using SendGrid;
using Serilog;
using IS4Amin.STS.Identity.Configuration;
using IS4Amin.STS.Identity.Configuration.ApplicationParts;
using IS4Amin.STS.Identity.Configuration.Constants;
using IS4Amin.STS.Identity.Configuration.Intefaces;
using IS4Amin.STS.Identity.Helpers.Localization;
using IS4Amin.STS.Identity.Services;
...
namespace IS4Amin.STS.Identity.Helpers
{
    public static class StartupHelpers
    {
            ...
            IConfiguration configuration)
        {
            ...
            //        options.ClaimActions.MapJsonKey("Alias", "name", "string");
